  ...
  <dialog ref="vehicleInfo" class="VehicleInfo">
    <div class="VehicleInfo__inner">
      ...
      <div v-if="currentVehicle" class="VehicleInfo__details">
        ...
        <img
          class="VehicleInfo__image"
          :src="`images/${currentVehicle.Url}.jpg`"
        ...
        <div class="VehicleInfo__stats">
          ...
          <div>
            <table class="VehicleInfo__table">
              <tr>
                <th>Speed</th>
                <td>{{ Math.round(currentVehicle.Speed) }}</td>
              </tr>
              <tr>
                <th>Acceleration</th>
                <td>{{ Math.round(currentVehicle.Acceleration) }}</td>
              </tr>
              <tr>
                <th>Braking</th>
                <td>{{ Math.round(currentVehicle.Braking) }}</td>
              </tr>
              <tr>
                <th>Handling</th>
                <td>{{ Math.round(currentVehicle.Handling) }}</td>
              </tr>
            </table>
        ...
        <div v-if="currentVehicle.ForSale || currentVehicle.Sellable" class="VehicleInfo__pricing">
          <div v-if="currentVehicle.ForSale">
            ...
            <div class="VehicleInfo__price">
              <strong>Purchase Price:</strong> {{ currentVehicle.Cost }}
            </div>
          </div>
